...
act <- read.csv("data/generated/intermediate/ABS_Cons_Actions_Broad.csv") 

## by eyeball, the only broad categories for which there is any difference amoung outcomes reproduction and mortality
...
narrow <- read.csv("data/generated/intermediate/ABS_Cons_Actions_Narrow.csv") %>% select_at(3:18)
...
inplace <- read.csv("data/redlist/rl_cons_inplace_2019.csv", stringsAsFactors = F) %>%
